...
public class HelloWorldServiceLocator extends org.apache.axis.client.Service implements com.phucvh.traning.HelloWorldService {
    ...
    private java.lang.String HelloWorld_address = "http://localhost:8080/SoapWebServiceBasic/services/HelloWorld";
    ...
    public com.phucvh.traning.HelloWorld getHelloWorld(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.phucvh.traning.HelloWorldSoapBindingStub _stub = new com.phucvh.traning.HelloWorldSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.phucvh.traning.HelloWorld.class.isAssignableFrom(serviceEndpointInterface)) {
                com.phucvh.traning.HelloWorldSoapBindingStub _stub = new com.phucvh.traning.HelloWorldSoapBindingStub(new java.net.URL(HelloWorld_address), this);
                _stub.setPortName(getHelloWorldWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://traning.phucvh.com", "HelloWorldService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://traning.phucvh.com", "HelloWorld"));
        }
