...
public class HelloWorldProxy implements com.phucvh.traning.HelloWorld {
  private String _endpoint = null;
  private com.phucvh.traning.HelloWorld helloWorld = null;
  ...
  private void _initHelloWorldProxy() {
    try {
      helloWorld = (new com.phucvh.traning.HelloWorldServiceLocator()).getHelloWorld();
      if (helloWorld != null) {
        if (_endpoint != null)
  ...
  public com.phucvh.traning.HelloWorld getHelloWorld() {
    if (helloWorld == null)
      _initHelloWorldProxy();
    return helloWorld;
  }
