...
<jsp:useBean id="sampleHelloWorldProxyid" scope="session" class="com.phucvh.traning.HelloWorldProxy" />
<%
...
case 10:
        gotMethod = true;
        com.phucvh.traning.HelloWorld getHelloWorld10mtemp = sampleHelloWorldProxyid.getHelloWorld();
